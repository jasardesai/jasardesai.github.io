...
game.load.image("backgroundImg", "../assets/background3.png")
game.load.image("pipeBlock","../assets/pipe_red.png")
game.load.image("PipeEnd", "../assets/pipe-end_red.png")
}
...
function create() {
  ...
  game.input.keyboard.addKey(Phaser.Keyboard.A).onDown.add(playerJump);
  game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR).onDown.add(player2Jump);
  game.input.keyboard.addKey(Phaser.Keyboard.UP).onDown.add(player3Jump);
