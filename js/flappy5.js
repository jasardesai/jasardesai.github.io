...
game.load.image("player5Img", "../assets/white-flappy.png")
game.load.audio("score", "../assets/point.ogg");
game.load.image("backgroundImg", "../assets/cloud.jpg")
game.load.image("pipeBlock","../assets/pipe_white.png")
game.load.image("PipeEnd", "../assets/pipe-end_white.png")
}
...
function create() {
  ...
  labelScore5 = game.add.text(20, 140, "Player 5 score : 0")
  ...
  player5 = game.add.sprite(100, 320, "player5Img")
  ...
  player5.scale.setTo(43 / 256, 33 / 178);
  generatePipe();
  ...
  player5.body.gravity.y = gravity;
  game.input.keyboard.addKey(Phaser.Keyboard.Q).onDown.add(playerJump);
  game.input.keyboard.addKey(Phaser.Keyboard.D).onDown.add(player2Jump);
  game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR).onDown.add(player3Jump);
  game.input.keyboard.addKey(Phaser.Keyboard.LEFT).onDown.add(player4Jump);
  game.input.keyboard.addKey(Phaser.Keyboard.RIGHT).onDown.add(player5Jump);
...
function update() {
  ...
  game.physics.arcade.overlap(
    ...
    if(player5.body.y < -40) {
      gameOver5();
    }
    if(player5.body.y > 440) {
      gameOver5();
    }
    ...
    player5.rotation = Math.atan(player5.body.velocity.y / 200);
}
function gameOver1() {
  player.kill();
  dead1 = true;
  if (dead2 && dead3 && dead4 && dead5){
    gameOverall()
  }
}
function gameOver2() {
...
function changeScore() {
  ...
  if(dead5 == false){
    score5 = score5 + 1;
    labelScore5.setText("Player 5 score : "+score5.toString())
}
}
function moveRight() {
  player.x += 10;
...
function player5Jump() {
  player5.body.velocity.y = jump;
}
function easy() {
  interval = -150
  interval2 = 2.5
